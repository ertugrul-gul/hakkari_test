...
plt.plot(df_train_temperature['valid_time'], y_train.values, label='Gerçek Değerler (Eğitim)')
plt.plot(df_train_temperature['valid_time'], y_pred_train, label='Tahminler (Eğitim)')
...
plt.figure(figsize=(10, 6))
plt.plot(df_test_temperature['valid_time'], y_test.values, label='Gerçek Değerler (Test)')
plt.plot(df_test_temperature['valid_time'], y_pred_test, label='Tahminler (Test)')
